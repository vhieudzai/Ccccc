...
Fluent:RegisterCustomTheme("Dark", {
    ...
    Background = "rbxassetid://123510710343253",
...
local Tabs = {
    ...
    Hop = Window:AddTab({ Title = "Tab Hop", Icon = "rbxassetid://6023426915" }),
}
...
Description = "Tự động farm mục tiêu gần nhất", 
Default = false, 
Callback = function(Value)
...
Description = "Tự động cày Ectoplasm", 
Default = false,
Callback = function(Value)
...
Title = "Stop Items", 
Description = "dừng lại khi có item", 
Default = true,
Callback = function(Value)
...
Description = "Tự động thu thập quả mọng", 
Default = false,
Callback = function(Value)
  _G.AutoBerry = Value
end})
...
Description = "Tự động thu thập Berry + Hop", 
Default = false,
Callback = function(Value)
  _G.AutoBerryH = Value
end})
...
Description = "Tấn công tự động - Rip Indra", 
Default = false,
Callback = function(Value)
...
Cake = Tabs.Main:AddToggle("Toggle_Auto_Farm_Cake_Prince", {
    ...
    Description = "Tấn công tự động Hoàng tử Bánh ngọt",
    Default = false,
    Callback = function(Value)
...
CakeSM = Tabs.Main:AddToggle("Toggle_Auto_Summon_Cake_Prince", {
    ...
    Description = "Tự động triệu hồi Hoàng tử Bánh ngọt",
    Default = false,
    Callback = function(Value)
...
Fluent:Notify({
  Title = "Vi Hieu Hub V3",
  Content = "Welcome To Vi Hieu Hub ",
...
Discord:AddParagraph({
    ...
    Content = "Bấm nút bên dưới để sao chép link tham gia server Discord chính thức của chúng tôi!"
})
...
Discord:AddButton({
    ...
    Callback = function()
        if setclipboard then
            ...
            print("Đã sao chép link cua vi hieu : " .. myDiscordLink)
            
            
            
        else
            warn("Executor của bạn không hỗ trợ tính năng setclipboard!")
        end
    end
})